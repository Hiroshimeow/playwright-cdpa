...
- Never retries automatically after an uncertain Send. Structural recovery of an existing conversation requires the persisted pre-Send baseline projection to match exact lowercase SHA-256 fingerprints before any user identity can be bound.
